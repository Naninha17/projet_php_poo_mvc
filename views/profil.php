        ...
        <div class="col-12 col-lg-6 mx-auto">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <!--Pas besoins de htmlspecialchars car il s'agit d'un objet "DateTime" qui ne peut être qu'une date valide-->
                    <td><?= ($_SESSION['user']->getRegisterDate()->format('d-m-Y H:i:s')) ?></td>
                </tr>
